"use client";
import { KitImageField } from "./KitPortraitField";
    ...
    if (selection.type === "ipSeries") {
      ...
      void run("save-kit", async () => {
        const id = await upsertKitVariant({
          ...
          fullBodyAssetKey: optional(kitDraft.fullBodyAssetKey),
        });
